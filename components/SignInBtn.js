...
const SignInBtn = () => {
  return (  
    <button className="hidden me-3 md:inline-flex items-center text-white signin_btn border-0 md:py-1 sm:py-2 lg:py-2 md:px-3 sm:px-7 lg:px-7 lg:space-x-3 sm:space-x-3 md:space-x-0
